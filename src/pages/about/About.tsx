    ...
    <Layout title="about">
      ...
      <AboutPageContainer>
        <div className="max-w-2xl text-gray-800">
          ...
          <div className="grid gap-6 grid-flow-col mt-12">
            <div>
              ...
              <div>
                ...
                <div className="mt-1 text-base text-gray-400">
                  We make certain decisions and act every day. Some people have
                  a very high probability of success in their decisions and
                ...
                <div className="mt-1 text-base text-gray-400">
                  Our lives really make a big difference depending on what
                  choices we make. We usually say "wise" to those who make good
                  choices. So where does this wisdom really come from?
                </div>
              </div>
            </div>
            <div className="h-full">
          ...
          <div className="mt-1 text-base text-gray-400">
            In our opinion, it is important to have a holistic and correct
            understanding of the world. "Don't miss important opportunities in
          ...
          <div className="mt-1 text-base text-gray-400">
            Therefore, we are working together to create various programs that
            can develop this wisdom with "IAM". We ask you to share and unite
            with us in a program that we carefully created with a variety of
            wisdom.
          </div>
          ...
          <div className="mt-5">
            ...
            각자의 기준 속 질서를 찾아 새로운 창조의 동력을 만들어 갑니다.
          </div>
          <div className="mt-1 text-gray-400">
            What kind of relationship should we have with society? In our
            opinion, "a life that pursues integrated wisdom beyond fragmentary
            knowledge" and "a life that understands the world correctly and
            lives in solidarity with society" are the essence that we should
            pursue without stopping. "IAM" finds order within their own
          ...
          <div className="mt-1 text-gray-400">
            ...
            only follow other people's dreams. I believe that the experience of
            looking back on "self" without being swept away by other people's
            voices will make the world better. "I AM" hopes that the main
            character of each drama in your future will be "Self."
          </div>
        </div>
